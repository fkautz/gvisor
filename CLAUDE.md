...
**YOU ARE IN: `gvisor/polecats/splendid/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/gvisor/` (rig root) or other directories

```bash
pwd  # Should show .../polecats/splendid
```
...
**Your mail address:** `gvisor/polecats/splendid`
**Your rig:** gvisor
**Your Witness:** `gvisor/witness`
...
1. Announce: "Polecat splendid, checking in."
2. Run: `gt prime`
...
| Ask Witness for help | `gt mail send gvisor/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`gvisor/witness`) when:
...
```bash
gt mail send gvisor/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
